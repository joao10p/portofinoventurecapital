...
<template>
    <div class="cardpro">
        ...
        <span><span class="areaname">{{ areaname }}</span> <span class="areaname1">{{ areaname1 }}</span></span>
            </div>
        
        <NuxtLink :to = "link" ><button class="open-button">Open description</button></NuxtLink>
    </div>
</template>

<script setup>
    const props = defineProps(['image','name', 'areaname' , 'areaname1', 'price' , 'subtitle' ,'link'])
</script>
